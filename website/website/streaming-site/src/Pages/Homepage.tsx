                  ...
                  <div className="swiper-wrapper">
                    ...
                    <div className="swiper-slide">
                      ...
                      >
                        <div className="img-bg-inner">
                          <h2>
                            17 Pictures of Medium Length Hair in Layers That Will Inspire Your New
                            Haircut
                          </h2>
                          <p>
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quidem neque
              ...
              <div className="col-lg-4">
                <div className="post-entry-1 lg">
                  ...
                  <p className="mb-4 d-block">
                    ...
                    repudiandae, inventore pariatur numquam cumque possimus exercitationem? Nihil
                    tempore odit ab minus eveniet praesentium, similique blanditiis molestiae ut
                    saepe perspiciatis officia nemo, eos quae cumque. Accusamus fugiat architecto
                ...
                <div className="row g-5">
                  <div className="col-lg-4 border-start custom-border">
                    <div className="post-entry-1">
                      ...
                      <div className="post-meta">
                        <span className="date">Sport</span> <span className="mx-1">&bullet;</span>{" "}
                        <span>Jul 5th '22</span>
                      </div>
                      <h2>
                    ...
                    <div className="post-entry-1">
                      ...
                      <div className="post-meta">
                        <span className="date">Food</span> <span className="mx-1">&bullet;</span>{" "}
                    ...
                    <div className="post-entry-1">
                      ...
                      <div className="post-meta">
                        <span className="date">Design</span> <span className="mx-1">&bullet;</span>{" "}
                  ...
                  <div className="col-lg-4 border-start custom-border">
                    ...
                    <div className="post-entry-1">
                      ...
                      <div className="post-meta">
                        <span className="date">Tech</span> <span className="mx-1">&bullet;</span>{" "}
                    ...
                    <div className="post-entry-1">
                      ...
                      <div className="post-meta">
                        <span className="date">Travel</span> <span className="mx-1">&bullet;</span>{" "}
                        <span>Jul 5th '22</span>
                      </div>
                      <h2>
                ...
                <div className="d-lg-flex post-entry-2">
                  ...
                  <div>
                    ...
                    <p>
                      ...
                      error deserunt aliquam temporibus sapiente, laudantium dolorum itaque libero
                      eos deleniti?
                    </p>
                    <div className="d-flex align-items-center author">
                      <div className="photo">
                ...
                <div className="row">
                  <div className="col-lg-4">
                    <div className="post-entry-1 border-bottom">
                      ...
                      <p className="mb-4 d-block">
                        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Vero temporibus
                        repudiandae, inventore pariatur numquam cumque possimus
                      </p>
                    </div>
            ...
            <div className="row">
              <div className="col-md-9 order-md-2">
                <div className="d-lg-flex post-entry-2">
                  ...
                  <div>
                    <div className="post-meta">
                      <span className="date">Business</span> <span className="mx-1">&bullet;</span>{" "}
                      <span>Jul 5th '22</span>
                    </div>
                    <h3>
                      <a href="single-post.html">
            ...
            <div className="row g-5">
              <div className="col-lg-4">
                <div className="post-entry-1 lg">
                  ...
                  <div className="post-meta">
                    <span className="date">Lifestyle</span> <span className="mx-1">&bullet;</span>{" "}
                    <span>Jul 5th '22</span>
                  </div>
                  <h2>
                    <a href="single-post.html">11 Work From Home Part-Time Jobs You Can Do Now</a>
