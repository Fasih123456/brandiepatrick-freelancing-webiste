          ...
          <div className="container">
            <div className="row g-5">
              <div className="col-lg-4">
                ...
                <p>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam ab, perspiciatis
                  beatae autem deleniti voluptate nulla a dolores, exercitationem eveniet libero
                  laudantium recusandae officiis qui aliquid blanditiis omnis quae. Explicabo?
                </p>
                <p>
                ...
                <ul className="footer-links list-unstyled">
                  ...
                  <li>
                    <a href="single-post.html">
                      <i className="bi bi-chevron-right"></i> Single Post
                    </a>
                  </li>
                  <li>
                    <a href="about.html">
